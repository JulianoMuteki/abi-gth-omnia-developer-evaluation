...
/// <summary>
/// Command for editing an existing sale.
/// </summary>
/// <remarks> 
/// It implements <see cref="IRequest{TResponse}"/> to initiate the request 
/// that returns a <see cref="EditSaleResult"/>.
/// 
/// The data provided in this command is validated using the 
/// <see cref="EditSaleCommandValidator"/> which extends 
...
{
    /// <summary>
    /// Gets or sets the unique identifier of the sale to edit.
    /// </summary>
    ...
    /// </summary>
    public List<EditSaleItemCommand> Items { get; set; } = new List<EditSaleItemCommand>();
...
/// <summary>
/// Command for editing a sale item.
/// </summary>
