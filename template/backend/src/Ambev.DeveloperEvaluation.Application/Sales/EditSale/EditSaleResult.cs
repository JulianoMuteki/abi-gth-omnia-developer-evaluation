...
/// <summary>
/// Result of the EditSale operation
/// </summary>
public class EditSaleResult
{
    /// <summary>
    /// The unique identifier of the edited sale
    /// </summary>
    ...
    /// <summary>
    /// The date and time when the sale was cancelled (if applicable)
    /// </summary>
    public DateTime? CancelledAt { get; set; }

    /// <summary>
    /// The ID of the user who cancelled the sale (if applicable)
    /// </summary>
    ...
    /// </summary>
    public List<EditSaleItemResult> Items { get; set; } = new List<EditSaleItemResult>();
}

/// <summary>
/// Result of the EditSaleItem operation
/// </summary>
public class EditSaleItemResult
{
    /// <summary>
    /// The unique identifier of the edited sale item
    /// </summary>
    public Guid Id { get; set; }
    ...
    /// <summary>
    /// The date and time when the item was cancelled (if applicable)
    /// </summary>
    public DateTime? CancelledAt { get; set; }

    /// <summary>
    /// The ID of the user who cancelled the item (if applicable)
    /// </summary>
    public Guid? CancelledBy { get; set; }
}
