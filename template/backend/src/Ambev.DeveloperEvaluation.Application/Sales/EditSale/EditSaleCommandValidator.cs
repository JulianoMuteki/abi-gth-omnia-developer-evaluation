...
/// <summary>
/// Validator for EditSaleCommand
/// </summary>
public class EditSaleCommandValidator : AbstractValidator<EditSaleCommand>
{
    /// <summary>
    /// Initializes a new instance of EditSaleCommandValidator
    /// </summary>
    public EditSaleCommandValidator()
    {
        ...
        RuleForEach(x => x.Items)
            .SetValidator(new EditSaleItemCommandValidator());
    }
}

/// <summary>
/// Validator for EditSaleItemCommand
/// </summary>
public class EditSaleItemCommandValidator : AbstractValidator<EditSaleItemCommand>
{
    /// <summary>
    /// Initializes a new instance of EditSaleItemCommandValidator
    /// </summary>
